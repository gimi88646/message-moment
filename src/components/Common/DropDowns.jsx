...
const QRCodeGeneratorDropdown = ({ toggleQrScanner, generatedLink }) => {
  return (
    <>
      <motion.div
        className="w-[100%] fixed bg-[black] bottom-[-15px] left-0 rounded-[9px_9px_0px_0px] text-[--White] maxTab:hidden"
        initial={{ y: 500 }}
        animate={{ y: 0 }}
        transition={{ duration: 0.4 }}
        id="qrScannerComponent"
      >
        <div className="w-full h-[45px] flex items-center text-[0.875rem] font-[300] pr-[6px] pl-4 justify-between">
          Scan QR Code
          <svg
            width="12"
            height="12"
          ...
          {/* <IoClose className="text-[21px]" onClick={toggleQrScanner} /> */}
        </div>

        <QRCodeGenerator
          generatedLink={generatedLink}
          classes="bg-[#151515] bg-cover bg-no-repeat pt-[20px] pb-[41px] w-full"
        />
      </motion.div>
    </>
  );
...
const ChatTypeDropdown = ({ toggleDropdown, handleLinkTypeChange }) => {
  return (
    <>
      <motion.div
        className="w-[100%] fixed bg-[black] bottom-[0px] left-0 rounded-[9px_9px_0px_0px] text-[--White] maxTab:hidden"
        initial={{ y: 500 }}
        animate={{ y: 0 }}
        transition={{ duration: 0.4 }}
      >
        ...
        <ul className="font-jetbrains text-[#FFF] text-[15px] font-[500] bg-[#151515] pb-4">
          <li
            className="w-full flex items-center justify-center"
            onClick={() => {
              handleLinkTypeChange("standard");
            }}
          >
            <div className="w-[93%] flex items-center gap-6 py-5">
              <svg
                width="16"
                height="16"
                viewBox="0 0 16 16"
              ...
              <span className="font-jetBrain text-[13px] translate-y-[1px] translate-x-[-1px]">
                Standard
              </span>
            </div>
          </li>
          ...
          <li
            className="w-full flex items-center justify-center"
            onClick={() => {
              handleLinkTypeChange("secure");
            }}
          >
            <div className="border-t border-white border-opacity-10 w-[93%] flex items-center gap-6 py-5">
              <svg
                width="13"
                height="16"
                viewBox="0 0 13 16"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="ml-[2px] mt-[1px] max-vsm:mb-[2px]"
              >
                <path
              ...
              <span className="font-jetBrain text-[13px]">Secure</span>
            </div>
          </li>
        </ul>
      </motion.div>
...
export { QRCodeGeneratorDropdown, ChatTypeDropdown };
